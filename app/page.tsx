...
export default function HomePage() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-paper-ivory text-charcoal selection:bg-ink-navy selection:text-paper-ivory">
      ...
      {/* SECTION 1: HERO */}
      <section className="relative bg-ink-navy text-paper-ivory min-h-[720px] lg:min-h-[820px] flex items-center pt-28 lg:pt-36 pb-20 overflow-hidden border-b border-hairline/20">
        {/* Subtle Architectural Gold Line Motif (No stock photos) */}
        ...
        <div className="max-w-container mx-auto px-5 md:px-12 lg:px-24 w-full relative z-10">
          <div className="max-w-3xl">
            ...
            <h1 className="font-fraunces text-4xl sm:text-5xl lg:text-7xl font-medium tracking-tightest leading-[1.08] mb-8 text-paper-ivory">
              FROM COMMERCE <br />
        ...
        <div className="max-w-container mx-auto px-5 md:px-12 lg:px-24">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-col items-center gap-1">
              ...
              <p className="font-mono text-[11px] uppercase tracking-mono text-slate">
